...
@NamedQueries({
        @NamedQuery(name = "StudyProgram.findAll", query = "SELECT s FROM StudyProgramEntity s"),
        @NamedQuery(name = "StudyProgram.findByTitle", query = "SELECT s FROM StudyProgramEntity s WHERE s.title LIKE :title")
})
